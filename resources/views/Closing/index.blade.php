...
<body class="overflow-x-hidden bg-black h-full">
    ...
    <div class="-mb-20 lg:-mb-0 lg:my-16" data-aos="fade-up">
        ...
        <div id="description" class="px-8 md:px-20 lg:px-80" data-aos="fade-up">
            <p class="font-ltmuseum text-md text-white text-justify md:text-center">Closing Night merupakan puncak dan penutup dari rangkaian acara RADIOACTIVE 2024 yang akan dilaksanakan secara offline. Kegiatan ini bertujuan untuk meningkatkan awareness dan engagement RADIOACTIVE sebagai acara tahunan dari UMN Radio.
            </p>
            <br>
            ...
            <div id="ticketType" class="flex flex-col md:flex-row gap-4 md:gap-24">
                <div id="ticket1" class="w-72 relative" data-aos="fade-up">
                    ...
                    <div class="absolute top-0 bottom-0 left-0 right-0">
                        <h4 class="font-brodyrawk text-2xl text-white text-center mt-12">EARLY BIRD</h4>
                        <p class="font-ltmuseum text-md text-white text-center">15-30 <br> September 2023</p>
                        <h4 class="font-ltmuseum text-white text-center font-bold mt-20">HTM <br> RP 30.000</h4>
