                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex flex-col gap-2 font-semibold">
                                ...
                                <form action="/dashboard/preorders/{{ $order->id }}/approvepreorder" method="post"
                                ...
                                <form action="/dashboard/preorders/{{ $order->id }}/cancelpreorder" method="post"
                                    enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                ...
                                <form action="/dashboard/preorders/{{ $order->id }}/suspendpreorder" method="post"
                                    enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                    <input type="text" placeholder="Reason" name="reason"
