          ...
          <table class="w-full table-auto">
              <thead>
                  <tr class="bg-gray-2 text-left">
                      ...
                      <th class="px-4 py-4 font-medium text-black">NIM Penyiar 1</th>
                      <th class="px-4 py-4 font-medium text-black">NIM Penyiar 2</th>
                      <th class="px-4 py-4 font-medium text-black">NIM OPERATOR</th>
                      <th class="px-4 py-4 font-medium text-black">WA</th>
                      <th class="px-4 py-4 font-medium text-black">LINE</th>
                      <th class="px-4 py-4 font-medium text-black">Bukti Pembayaran</th>
                          ...
                          <td class="border-b border-[#eee] px-4 py-5">
                              <div class="flex items-center space-x-3.5">
                                  <button class="hover:text-primary">
                                      <a href="/dashboard/racs/{{ $rac->id }}/edit">
                                  ...
                                  <form action="/dashboard/racs/{{ $rac->id }}" method="post" onsubmit="return confirmDeletion()">
                                    @method('delete')
                                    @csrf
                                    <button class="hover:text-primary">
