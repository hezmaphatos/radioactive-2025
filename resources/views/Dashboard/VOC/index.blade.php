...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
  ...
  @endif
{{-- Start Searching --}}
  <form class="max-w-md" action="/dashboard/users" method="GET">
    @csrf   
        ...
        <tbody>
          @foreach ($vocs as $voc)
            <tr>
              ...
              <td>
                <p class="text-black dark:text-white">{{ $voc->usia }}
              </td>
              <td>
                <p class="text-black dark:text-white">{{ $voc->no_telp }}
              </td>
              <td>
                <p class="text-black dark:text-white">{{ $voc->email }}
              </td>
              <td>
                <p class="text-black dark:text-white">{{ $voc->nim }}
              </td>
              <td>
                <p class="text-black dark:text-white">{{ $voc->uname }}
              </td>
              <td>
                <p class="text-black dark:text-white">{{ $voc->link }}
              </td>
              <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                <div class="flex items-center space-x-3.5">
                  <button class="hover:text-primary">
                    ...
                    <form action="/dashboard/voc/{{ $voc->id }}" method="post">
                        @method('delete')
                        @csrf
                        <button class="hover:text-primary">
