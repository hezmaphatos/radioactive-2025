    ...
    <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{selected: $persist('Dashboard')}">
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          <li>
            <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out {{ Request::is('dashboard') ? 'bg-graydark' : '' }} hover:bg-graydark dark:hover:bg-meta-4" href="/dashboard">
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out {{ Request::is('dashboard/users*') ? 'bg-graydark' : ''}} hover:bg-graydark dark:hover:bg-meta-4"
          ...
          {{-- <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out {{ Request::is('dashboard/macs*') ? 'bg-graydark' : ''}} hover:bg-graydark dark:hover:bg-meta-4"
              href="/dashboard/macs"
            >
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out {{ Request::is('dashboard/merches*') ? 'bg-graydark' : ''}} hover:bg-graydark dark:hover:bg-meta-4"
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out {{ Request::is('dashboard/orders*') ? 'bg-graydark' : ''}} hover:bg-graydark dark:hover:bg-meta-4"
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out {{ Request::is('dashboard/preorders*') ? 'bg-graydark' : ''}} hover:bg-graydark dark:hover:bg-meta-4"
