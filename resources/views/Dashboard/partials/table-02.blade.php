...
>
    ...
    <div class="col-span-3 flex items-center">
      <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
        <div class="h-12.5 w-15 rounded-md">
            <img src="{{ asset('images/product/product-01.png') }}" alt="Brand">
        </div>
  ...
  >
    <div class="col-span-3 flex items-center">
      <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
        <div class="h-12.5 w-15 rounded-md">
            <img src="{{ asset('images/product/product-02.png') }}" alt="Brand">
        </div>
        <p class="text-sm font-medium text-black dark:text-white">
          Macbook Pro M1
        </p>
  ...
  >
    <div class="col-span-3 flex items-center">
      <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
        <div class="h-12.5 w-15 rounded-md">
            <img src="{{ asset('images/product/product-03.png') }}" alt="Brand">
        </div>
        <p class="text-sm font-medium text-black dark:text-white">
          Dell Inspiron 15
        </p>
  ...
  >
    <div class="col-span-3 flex items-center">
      <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
        <div class="h-12.5 w-15 rounded-md">
            <img src="{{ asset('images/product/product-04.png') }}" alt="Brand">
        </div>
        <p class="text-sm font-medium text-black dark:text-white">
          HP Probook 450
        </p>
