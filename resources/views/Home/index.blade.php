...
<body class="overflow-x-hidden bg-black">
    ...
    <div id="section-1" class="pt-32 max-w-4xl mx-auto">
        ...
        <div class="relative flex flex-col items-center" data-aos="fade-up" data-aos-duration="3000">
            <img class="object-cover -mt-4 md:-mt-28 z-0" src="images/LOGO RADIOACTIVE 2024.png" alt="background logo" />
...
<div class="flex flex-wrap md:flex-nowrap px-4 md:px-12 mt-10 space-y-8 md:space-y-0">
    ...
    <div class="w-full md:w-1/4 p-4 md:p-6">
        ...
        <ul class="sm:flex md:block">
            <li class="text-yellow-600 mb-1 md:mb-2"><a data-filter="all" class="filter-link hover:opacity-50 no-underline font-ltmuseumreg">ALL</a></li>
            <li class="text-gray-500 mb-1 md:mb-2"><a data-filter="voc" class="filter-link hover:opacity-50  no-underline font-ltmuseumreg">VOC</a></li>
            <li class="text-gray-500 mb-1 md:mb-2"><a data-filter="rac" class="filter-link hover:opacity-50  no-underline font-ltmuseumreg">RAC</a></li>
            <li class="text-gray-500"><a data-filter="closing-night" class="filter-link hover:opacity-50  no-underline font-ltmuseumreg">CLOSING NIGHT</a></li>
        </ul>
    </div>
    ...
    <div class="w-full md:flex-1 grid gap-2 md:gap-4" id="gallery">
        ...
        <div class="filter-item grid grid-cols-2 sm:grid-cols-3 gap-2 md:gap-4" data-category="voc">
            <img src="images/VOC/1.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
            <img src="images/VOC/2.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
            <img src="images/VOC/3.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
            <img src="images/VOC/4.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
        </div>
    
        <!-- RAC Section -->
        <div class="filter-item grid grid-cols-2 sm:grid-cols-3 gap-2 md:gap-4" data-category="rac">
            <img src="images/RAC/1.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
            <img src="images/RAC/2.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
            <img src="images/RAC/3.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
            <img src="images/RAC/4.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
            <img src="images/RAC/5.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
            <img src="images/RAC/6.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
        </div>
    
        <!-- Closing Night Section -->
        <div class="filter-item grid grid-cols-2 sm:grid-cols-3 gap-2 md:gap-4" data-category="closing-night">
            <img src="images/CLOSING NIGHT/1.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
            <img src="images/CLOSING NIGHT/2.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
            <img src="images/CLOSING NIGHT/3.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
            <img src="images/CLOSING NIGHT/4.jpg" class="w-full h-48 object-cover rounded-lg shadow-lg transform hover:scale-105 transition duration-300 cursor-pointer hover:opacity-50" onclick="openPopup(this.src)">
        </div>
    </div>
    
    <div id="popup" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center hidden z-50" onclick="closePopup()">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function showCategory(category) {
            gallery.innerHTML = `<div class="grid grid-cols-1 md:grid-cols-3 gap-4">${categories[category].join('')}</div>`;
        }

        function randomizeGallery() {
            const shuffledImages = allImages.sort(() => Math.random() - 0.5).slice(0, 3);
            gallery.innerHTML = `<div class="grid grid-cols-1 md:grid-cols-3 gap-4">${shuffledImages.join('')}</div>`;
        }
