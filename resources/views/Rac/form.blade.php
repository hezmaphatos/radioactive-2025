                    ...
                    <div class="flex flex-col w-[400px] max-w-[95vw]">
                        <div class="w-full form-content shadow-md  px-8 py-3 mb-10 font-pathway shadow-[#D61625]">
                            ...
                            @if (session()->has('success'))
                                <div class="text-sm text-green-500 font-ltmuseumbold" role="alert">
                                    {{ session('success') }}</div>
                            @endif
                            <div>
                                <div class="mb-1">
                                ...
                                <div class="mb-1">
                                    <div>
                                        <label class="block form-label text-sm mb-0 font-ltmuseumbold"
                                            for="">Penyiar
                                            2</label>
                                    </div>
                                    <div>
                            ...
                            <div>
                                <div class="mb-1">
                                    <div>
                                        <label class="block form-label text-sm mb-0 font-ltmuseumbold" for="">Nomor
                                            WA
                                            Perwakilan</label>
                                    </div>
                                    <div>
                        ...
                        <div class="w-full form-content shadow-md px-8 py-3 mb-4 font-pathway shadow-[#D61625]">
                            <div class="mb-1">
                                <div>
                                    <label class="block font-brodyrawk text-center text-xl md:text-2xl form-label mb-0"
                                        for="">Bukti Pembayaran</label>
                                </div>
                                <div>
                                    <h6 class="text-lg font-ltmuseumbold">Pembayaran sebesar Rp 130.000,~ ke BCA 6600448160
                                        a/n Helena Hanna Haryadi</h6>
                                </div>
                                <div>
                                    <input required
                            ...
                            <div id="confirmationModal"
                                ...
                                <div class="bg-white w-11/12 md:w-1/3 p-5 rounded-lg shadow-lg">
                                    ...
                                    <p class="text-black mb-6 font-ltmuseumreg">Pastikan data yang dimasukkan benar adanya.
                                    </p>
                                    <div class="flex justify-end">
                                        <button class="bg-gray-300 text-gray-700 px-4 py-2 rounded mr-2 font-ltmuseum"
                                            data-modal-close>Cancel</button>
                                        <button class="bg-[#D61625] text-white px-4 py-2 rounded font-ltmuseum"
                        ...
                        <div class="flex justify-center w-full">
                            <div
                                ...
                                <div class="mb-1">
                                    ...
                                    <div>
                                        <h6 class="text-lg font-ltmuseumbold">Pembayaran sebesar Rp 250.000,~ ke BCA
                                            6600448160 a/n Helena Hanna Haryadi</h6>
                                    </div>
                                    <div>
                                        <input required
                                            class="block @error('payment_proof') border-red-500 @enderror w-full mb-5 text-xs text-gray-900 border  cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 font-ltmuseumreg"
                                ...
                                <div id="confirmationModal"
                                    ...
                                    <div class="bg-white w-11/12 md:w-1/3 p-5 rounded-lg shadow-lg">
                                        <h2 class="font-ltmuseumbold text-xl mb-4 text-black">Konfirmasi Pendaftaran</h2>
                                        <p class="text-black mb-6 font-ltmuseumreg">Pastikan data yang dimasukkan benar
                                            adanya.</p>
                                        <div class="flex justify-end">
                                            <button class="bg-gray-300 text-gray-700 px-4 py-2 rounded mr-2 font-ltmuseum"
                                                data-modal-close>Cancel</button>
                        ...
                        <div class="flex justify-center w-full">
                            <div
                                ...
                                <div class="mb-1">
                                    ...
                                    <div>
                                        <h6 class="text-lg font-ltmuseumbold">Pembayaran sebesar Rp 380.000,~ ke BCA
                                            6600448160 a/n Helena Hanna Haryadi/h6>
                                    </div>
                                    <div>
                                        <input required
