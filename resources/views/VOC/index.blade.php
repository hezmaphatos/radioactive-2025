    ...
    <footer class=" pt-14">
            ...
            <div class=" flex justify-between items-center border-t border-red-300">
                ...
                <div class="flex justify-center gap-4">
                    ...
                    <a href="/voc" class="  text-sm font-ltmuseum text-white underline underline-offset-8 decoration-[#D61525] cursor-pointer"
                    >VO CHALLENGE
                    </a>
        ...
        <div class="mobile-footer md:hidden pt-14">
            <div class="">
                ...
                <div class="flex flex-col mb-2 ml-16 tracking-[0.1em]">
                    ...
                    <a href="/voc" class="  text-sm font-ltmuseum text-white underline underline-offset-4 decoration-[#D61525] cursor-pointer"
                    >VO CHALLENGE
                    </a>
