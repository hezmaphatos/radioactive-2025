...
<body>
    ...
    <p>Your merch preorder has been placed, please wait for our confirmation email. Thank you for your order!!</p>

    <h3>Order Details:</h3>
    <p>Order ID: {{$data['order_id']}}</p>
    <p>Total Price: Rp. {{ number_format($data['total_price'], 0, ',', '.') }}</p>
    
    <p>For further details, click this link <a href="umnradioactive.com/merch/preorder/{{$data['order_id']}}">Preorder Details</a></p>
